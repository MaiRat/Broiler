...
internal static class HtmlUtils
{
    ...
    private static readonly Dictionary<string, char> _decodeOnlyCaseSensitive = new(StringComparer.InvariantCulture);
    ...
    private static string DecodeHtmlCharByName(string str)
    {
        ...
        while (idx > -1)
        {
            ...
            if (endIdx > -1 && endIdx - idx < 8)
            {
                ...
                if (_decodeOnlyCaseSensitive.TryGetValue(key, out char c))
                {
