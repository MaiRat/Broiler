...
internal static class SyntaxNodeExtensions
{
    ...
    public static bool IsGeneratorAttributeName(this string name) => name.StartsWith("JSClassGenerator")
    ...
    private static bool IsEnumeration(ISymbol type) => GetAttribute(type) != null;
