...
public abstract class V8InspectorProtocol : JSDebugger, IDisposable
{
   ...
   //};
    ...
    public Dictionary<long, JSContext> Contexts = [];

    public Dictionary<string, JSFunctionDelegate> InjectedScripts = [];
    ...
    {
        var id = $"C-{context.ID}";
        Send(new V8Runtime.ConsoleApiCalled(id, context, type, in a));
    }
