...
public static class KeyStrings
{
    ...
    public static KeyString GetOrCreate(in StringSpan key) => map.GetOrCreate(key, (keyName) =>
                                                                       {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    internal static bool TryGet(in StringSpan key, out KeyString ks) => map.TryGetValue(key, out ks);
