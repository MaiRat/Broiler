...
public class JSReflectStatic
{
    ...
    public static JSValue GetPrototypeOf(in Arguments a) => a.Get1().GetPrototypeOf();
    ...
    [Static("ownKeys")]
    public static JSValue OwnKeys(in Arguments a) => JSObject.GetOwnPropertyNames(a);

    [Static("preventExtensions")]
    public static JSValue PreventExtensions(in Arguments a) => JSObject.PreventExtensions(a);
