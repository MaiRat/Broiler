...
public class FastTokenStream
{
    ...
    public readonly struct Marker(FastTokenStream stream, FastToken index, bool linesSkipped)
    {
        public readonly bool LinesSkipped = linesSkipped;

        public void Undo() => stream.current = index;
    }
