...
public class FastPool
{
    ...
    public FastList<T> AllocateList<T>() => new(this);

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public FastList<T> AllocateList<T>(int size) => new(this, size);
    ...
    class Pool<T>
    {
        ...
        public T[] AllocateArray(int size) => AllocateInternal(size);
    ...
    private readonly Queue<StringBuilder> fastStringBuilders = new();
