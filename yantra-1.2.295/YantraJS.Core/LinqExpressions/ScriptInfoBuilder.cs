...
public static class ScriptInfoBuilder
{
    ...
    public static Expression Code(Expression scriptInfo) => scriptInfo.FieldExpression<ScriptInfo, string>(() => (x) => x.Code);// return Expression.Field(scriptInfo, _code);

    public static Expression FileName(Expression scriptInfo) => scriptInfo.FieldExpression<ScriptInfo, string>(() => (x) => x.FileName);// return Expression.Field(scriptInfo, _fileName);

    public static Expression KeyString(Expression scriptInfo, int index) => Expression.ArrayIndex(
