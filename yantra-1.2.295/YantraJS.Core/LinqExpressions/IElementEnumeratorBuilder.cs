...
public class IElementEnumeratorBuilder
{
    ...
    public static Expression MoveNext(Expression target, Expression item) => target.CallExpression<IElementEnumerator, JSValue, bool>(
    ...
    public static Expression AssignMoveNext(
        Expression assignee,
        Expression target) => Expression.Assign(assignee,
