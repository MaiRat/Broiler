...
public class JSContextBuilder
{
    ...
    public static Expression Index(Expression key) =>
        ...
        Expression.MakeIndex(Current, _Index, [key]);

    public static Expression NewTarget() => Current
    ...
    public static Expression Register(ParameterExpression lScope, ParameterExpression variable) => lScope.CallExpression<JSContext, JSVariable, JSValue>(
            () => (x, a) => x.Register(a),
            variable);// return Expression.Call(lScope, _Register, variable);
}
