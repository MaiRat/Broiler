...
public class GeneratorRewriter(
        ...
        ) : YExpressionMapVisitor
{
    ...
    private LabelTarget generatorReturn = Expression.Label(typeof(GeneratorState), "RETURN");
    ...
    private (Sequence<ParameterExpression> boxes, Expression init) LoadBoxes()
    {
        ...
        {
            ClrGeneratorV2Builder.InitVariables(pe, lifted.Count)
        };
