...
public class YExpressionMapVisitor : YExpressionVisitor<YExpression>
{
    ...
    protected override YExpression VisitConstant(YConstantExpression yConstantExpression) => yConstantExpression;

    protected override YExpression VisitDebugInfo(YDebugInfoExpression node) => node;

    protected override YExpression VisitDelegate(YDelegateExpression yDelegateExpression) => yDelegateExpression;

    protected override YExpression VisitEmpty(YEmptyExpression exp) => exp;
    ...
    protected override YExpression VisitILOffset(YILOffsetExpression node) => node;
    ...
    protected override YExpression VisitParameter(YParameterExpression yParameterExpression) => yParameterExpression;
    ...
    protected override YExpression VisitStringConstant(YStringConstantExpression node) => node;

    protected override YExpression VisitBooleanConstant(YBooleanConstantExpression node) => node;

    protected override YExpression VisitFloatConstant(YFloatConstantExpression node) => node;

    protected override YExpression VisitDoubleConstant(YDoubleConstantExpression node) => node;

    protected override YExpression VisitUInt64Constant(YUInt64ConstantExpression node) => node;

    protected override YExpression VisitInt64Constant(YInt64ConstantExpression node) => node;

    protected override YExpression VisitUInt32Constant(YUInt32ConstantExpression node) => node;

    protected override YExpression VisitInt32Constant(YInt32ConstantExpression node) => node;

    protected override YExpression VisitByteConstant(YByteConstantExpression node) => node;

    protected override YExpression VisitTypeConstant(YTypeConstantExpression node) => node;

    protected override YExpression VisitMethodConstant(YMethodConstantExpression node) => node;
