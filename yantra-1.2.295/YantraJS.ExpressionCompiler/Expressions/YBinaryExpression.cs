...
public class YBinaryExpression(YExpression left, YOperator @operator, YExpression right) : YExpression(YExpressionType.Binary, GetType(@operator, left.Type, right.Type))
{
    ...
    public readonly YOperator Operator = @operator;
    ...
    public YExpression Update(YExpression left, YOperator @operator, YExpression right) => new YBinaryExpression(left, @operator, right);
