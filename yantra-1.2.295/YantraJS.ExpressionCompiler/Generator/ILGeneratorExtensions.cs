...
public static class ILGeneratorExtensions
{
    ...
    public static void EmitConstant(this ILWriter il, MethodInfo method) => il.Emit(OpCodes.Ldftn, method);
    ...
    public static void EmitNew(this ILWriter il, ConstructorInfo c) => il.Emit(OpCodes.Newobj, c);

    public static void EmitConstant(this ILWriter il, float value) => il.Emit(OpCodes.Ldc_R4, value);

    public static void EmitConstant(this ILWriter il, double value) => il.Emit(OpCodes.Ldc_R8, value);

    public static void EmitConstant(this ILWriter il, bool value) => il.Emit(value ? OpCodes.Ldc_I4_1 : OpCodes.Ldc_I4_0);

    public static void EmitConstant(this ILWriter il, uint i) => il.EmitConstant(unchecked((int)i));



    public static void EmitConstant(this ILWriter il, ulong i) => il.EmitConstant(unchecked((long)i));

    public static void EmitConstant(this ILWriter il, long i) => il.Emit(OpCodes.Ldc_I8, i);
