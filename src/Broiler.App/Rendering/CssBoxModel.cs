...
namespace Broiler.App.Rendering
{
    ...
    public class GridTrackSize
    {
        ...
        /// <summary>Unit of the track size.</summary>
        public GridTrackUnit Unit { get; set; }

        /// <summary>Initializes a new <see cref="GridTrackSize"/>.</summary>
        public GridTrackSize(float value, GridTrackUnit unit)
    ...
    public class LayoutBox
    {
        ...
        public List<GridTrackSize> GridTemplateColumns = new List<GridTrackSize>();
        /// <summary>Grid template row track definitions.</summary>
        public List<GridTrackSize> GridTemplateRows = new List<GridTrackSize>();
