...
namespace Broiler.App.Rendering
{
    ...
    public sealed class HtmlToken
    {
        ...
        /// <summary>Creates a new <see cref="HtmlToken"/>.</summary>
        public HtmlToken(TokenType type, string name = null, string data = null,
    ...
    public sealed class HtmlTokenizer
    {
        ...
        private readonly StringBuilder _tag = new StringBuilder();
        private readonly StringBuilder _buf = new StringBuilder();
        private readonly StringBuilder _av = new StringBuilder();
        ...
        private static HtmlToken Eof() => new HtmlToken(TokenType.EndOfFile);
